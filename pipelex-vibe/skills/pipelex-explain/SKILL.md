...
| `mthds_get_method` is absent while the other tools answer | explain the id at contract level, say the source was not read, and name both causes [not-on-disk.md](references/not-on-disk.md) gives |
