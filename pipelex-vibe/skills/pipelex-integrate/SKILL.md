...
**Check containment before writing anything**: the project root must sit at or under the directory this session was launched in, both resolved (`pwd -P`, `realpath`), or STOP: relaunch the harness from the project root, or register the workshop there. **Never write the tree into the workshop's directory and move it across.**
