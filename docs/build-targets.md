...
| `harness_name` | `defaults.toml` (overridden per target) | `credentials.md.j2`, `mcp-requirements.md.j2` and `skill-dir.md.j2`, which name the harness to the user or the model |
