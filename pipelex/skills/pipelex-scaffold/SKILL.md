...
- [references/version-managers.md](references/version-managers.md) — `node` or `uv` reached through a version manager the machine already has, before stopping on it.
