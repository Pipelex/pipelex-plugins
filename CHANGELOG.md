...
- Build documentation: `docs/build-targets.md` describing the multi-target build, and `docs/hooks.md` describing the validation pipeline, the CLI-free silent-pass posture, per-platform wiring, and the Codex enablement note.
