...
| **Generated types** | `src/generated/<name>/` — `types.ts`, `binder.ts`, `contracts.ts`, `codegen.lock`, `sources.json` | `<package>/generated/<name>/`, the method directory's dashes turned into underscores — `models.py`, `codegen.lock` |
