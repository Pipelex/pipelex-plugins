...
| The target directory exists and is not empty | STOP, ask for another; never delete, move or write into it, **and never offer to make room** — amended 2026-09-12 (Phase 3), after a run refused the directory and then offered to move the user's file aside and merge it back afterwards |
